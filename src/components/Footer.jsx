            ...
            <div className="flex flex-wrap justify-center md:justify-start gap-6 text-sm text-gray-400 mb-6 md:mb-0">
              <div className="group relative cursor-pointer">
                ...
                <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-3 w-72 bg-gray-800 border border-gray-600 text-gray-200 text-xs rounded-xl p-4 opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none z-50 shadow-2xl">
                  <p className="font-semibold text-white mb-2 text-sm">Privacy Policy</p>
                  <p className="leading-relaxed">We collect and process your personal data in accordance with applicable privacy laws. Your data is used to provide our services, improve user experience, and communicate relevant opportunities. We never sell your data to third parties.</p>
